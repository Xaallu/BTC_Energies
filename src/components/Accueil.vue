  ...
  data() {
    return {
      team: [
        ...
        { name: 'Marie-Pierre Lefebvre', title: 'Direction Administrative et Financière', roleKey: 'Direction_Administrative_Et_Financière', img: '/Trombi/MP_L.png', slug: 'MariePierreLefebvre' },
